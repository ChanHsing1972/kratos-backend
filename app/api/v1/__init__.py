...
from app.api.v1.endpoints.agent_session import router as agent_session_router
...
api_router.include_router(agent_session_router, prefix="/agent", tags=["agent-sessions"])
